...
public class LaporanMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoWindow(final Marker marker) {
                ...
                Glide.with(LaporanMapActivity.this).load(link_img).asBitmap().override(250,250).listener(new RequestListener<String, Bitmap>() {
                    @Override
